Namespace T179722
    Partial Public Class Form1
        ...
        Private Sub InitializeComponent()
            ...
            DirectCast(Me.grdTasks, System.ComponentModel.ISupportInitialize).BeginInit()
            DirectCast(Me.gridViewTasks, System.ComponentModel.ISupportInitialize).BeginInit()
            DirectCast(Me.repSpinDuration, System.ComponentModel.ISupportInitialize).BeginInit()
            DirectCast(Me.repPriority, System.ComponentModel.ISupportInitialize).BeginInit()
            DirectCast(Me.repSeverity, System.ComponentModel.ISupportInitialize).BeginInit()
            Me.SuspendLayout()
            ' 
            ' schedulerControl
            ' 
            ...
            DirectCast(Me.grdTasks, System.ComponentModel.ISupportInitialize).EndInit()
            DirectCast(Me.gridViewTasks, System.ComponentModel.ISupportInitialize).EndInit()
            DirectCast(Me.repSpinDuration, System.ComponentModel.ISupportInitialize).EndInit()
            DirectCast(Me.repPriority, System.ComponentModel.ISupportInitialize).EndInit()
            DirectCast(Me.repSeverity, System.ComponentModel.ISupportInitialize).EndInit()
